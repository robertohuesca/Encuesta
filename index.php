...
<html>
    ...
    <body>
        <header>
            <nav>
             ...
             <div id="obj" class="arrow_box"  style="display:none">
               ...
               <div id="user"> Usuario: <?php echo $_SESSION['usuario'];?></div>
                <div id="tipo"> Tipo usuario: <?php echo $_SESSION['categoria'];?></div>
                 <div id="tutor">Tutor: <?php echo $_SESSION['tutor'];?></div>
                 <div id="tutor">Semestre: <?php echo $_SESSION['grupo']." ".$_SESSION['grado'];?></div>
        ...
        <div class="fond" >
               <section> 
                <article>
                    <h1 id="titulo">FICHA DE DIAGNOSTICO INICIAL</h1>     
                    <div id="linea"></div>       
                </article>
            </section>
        </div>
        ...
        <!--<div id="titulo" >
            ...
            <div class="tile"> 
                <img  class="rotateMe" src="images/Chat-256.png" width="80px">
            ...
            <div class="tile">
                <img  class="rotateMe"src="images/Adobe-Acrobat-256.png" width="80px">
            ...
            <div class="tile"> 
                <img class="rotateMe" src="images/User-256.png" width="80px">
    ...
    <footer> 
        <label>
             Ayuda     Contacto   Home<br>
            © 2016 | COBATAB | ALL RIGTH RESERVED | robertohuesca@outlook.com
        </label>
    </footer>
</html>
